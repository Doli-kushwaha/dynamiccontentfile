...
<div id="container">
                ...
                <div class="col-lg-12">
                    <div id="inputFormRow">
                        <div class="input-group mb-3">
                        	...
                        	<div class="col-mb-3">
                            <input type="text" name="username[]" class="form-control m-input" placeholder="Enter your name" autocomplete="off" value="<?= $username[$i]?>">
                            </div>

                              <div class="col-mb-3">
                            <input type="text" name="uemail[]" class="form-control m-input" placeholder="Enter your email" autocomplete="off" value="<?= $user_email[$i]?>">
                        </div>
                            <div class="col-mb-3">
                             <input type="text" name="mobno[]" class="form-control m-input" placeholder="Enter your Mobile number" autocomplete="off" value="<?= $usermob[$i]?>">
                         </div>
                          <div class="col-mb-3">
  ...
  <script type="text/javascript">
        ...
        $("#addRow").click(function () {
            ...
            html += '<button id="removeRow" type="button" class=""></button>';
            html += '</div>';
            html += '</div><tr></table>';
